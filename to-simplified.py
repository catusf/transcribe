...
def convert_traditional_to_simplified(input_dir, output_dir):
    ...
    for filename in os.listdir(input_dir):
        ...
        if os.path.isfile(input_filepath) and (filename.endswith('.txt') or filename.endswith('.srt')):
            ...
            print(f"Converted {filename} to Simplified Chinese and saved to {output_filepath}")
